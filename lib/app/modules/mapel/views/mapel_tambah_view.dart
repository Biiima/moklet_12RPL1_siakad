...
import 'package:mapel/app/data/models/model_karyawan.dart';

import '../controllers/mapel_tambah_controller';
          ...
          child: ListView(
            children: [
              ...
              Obx(() => DropdownButtonFormField<int>(
                    ...
                    // items: controller.guruPengajar.map(
                    //   (DataKaryawan guru) => DropdownMenuItem(
                    //     child: Text(guru.name!),
                    //     value: guru.id!,
                    //   ),
                    // ),
                    items: controller.guruPengajar.map((DataKaryawan guru) {
